...
После успешного развёртывания сайт будет доступен по адресам:
- **http://77.222.42.53**
- **http://77-222-42-53.swtest.ru**
...
- **URL**: https://77-222-42-53.swtest.ru:1500
- **Логин**: root
- **Пароль**: TyqXum*tBdg3e4T7
...
## 🎯 Тестирование локально с Docker
